    ...
    <footer className="border-t border-espresso/10 bg-espresso">
      <div className="mx-auto max-w-350 px-6 md:px-10 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10">
          <div className="col-span-2">
            <div className="flex items-start gap-4 mb-4">
              <div>
                <p className="font-display text-xl text-ivory leading-tight">OGNLS</p>
                <p className="font-mono-label text-[10px] uppercase text-ivory py-0.5">Wear The Originals</p>
              </div>
          ...
          <div>
            <h3 className="font-mono-label text-[11px] uppercase text-brass mb-4">Shop</h3>
            <ul className="space-y-2.5">
              {shopCategories.map(category => (
                <li key={category.slug}>
                  <Link href={`/c/${category.slug}`} className="text-sm text-ivory/60 hover:text-brass stitch-underline">
                    {category.name}
                  </Link>
                </li>
              ))}
          ...
          {STATIC_COLUMNS.map(col => (
            <div key={col.heading}>
              ...
              <ul className="space-y-2.5">
                {col.links.map(link => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-sm text-ivory/60 hover:text-brass stitch-underline">
                      {link.label}
                    </Link>
                  </li>
                ))}
          ...
          <div>
            ...
            <div className="flex gap-3 mb-5">
              ...
              <a href="#" aria-label="Facebook" className="text-ivory/60 hover:text-brass transition-colors">
              ...
              <a href="#" aria-label="Pinterest" className="text-ivory/60 hover:text-brass transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <p className="text-xs text-ivory/40">© {new Date().getFullYear()} Wear The Originals. All rights reserved.</p>

          <div className="flex gap-6">
            <Link href="/terms" className="text-xs text-ivory/40 hover:text-brass stitch-underline">
              Terms & Conditions
            </Link>
            <Link href="/privacy" className="text-xs text-ivory/40 hover:text-brass stitch-underline">
              Privacy Policy
            </Link>
            <Link href="/cookie-policy" className="text-xs text-ivory/40 hover:text-brass stitch-underline">
              Cookie Policy
            </Link>
          </div>
        </div>
